...
# Default paths (adjusted for VC_replan-mcp project layout)
DEFAULT_CONFIG_DIR = Path(__file__).parent.parent / "config" / "cli_clients"
DEFAULT_SYSTEMPROMPTS_DIR = Path(__file__).parent.parent / "config" / "systemprompts"
...
INTERNAL_DEFAULTS: dict[str, dict] = {
    ...
    "codex": {
        "command": "codex",
        "additional_args": ["exec", "--json", "--dangerously-bypass-approvals-and-sandbox"],
        "timeout_seconds": DEFAULT_TIMEOUT_SECONDS,
        "parser": "codex_jsonl",
    },
    "claude": {
